...
function animate(change, time) {
  ...
  var getMoment = function getMoment() {
    return (performance.now() - start) / time;
  };
...
function createIcosahedronAnimation(icosahedron, setTextures) {
  return function _callee() {
    var startX, startY, startZ, coffX, coffY, coffZ;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(animate(function (dat) {
          ...
          case 2:
            startX = icosahedron.rotation.x;
            startY = icosahedron.rotation.y;
            startZ = icosahedron.rotation.z;
            setTextures(icosahedron);
            coffX = 0.35 - icosahedron.rotation.x;
            coffY = -3.08 - icosahedron.rotation.y;
            coffZ = -1.55 - icosahedron.rotation.z;
            _context.next = 11;
            return regeneratorRuntime.awrap(animate(function (dat) {
...
function createAnimator(group, icosahedron, setTextures) {
  var animateIcosahedron = createIcosahedronAnimation(icosahedron, setTextures);
  var drag = createDragAnimation(group);
    ...
    return regeneratorRuntime.async(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            _context3.next = 6;
            return regeneratorRuntime.awrap(drag());
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","animation.js"], null)
